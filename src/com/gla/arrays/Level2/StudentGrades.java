...
public class StudentGrades {
    public static void main(String[] args) {
        ...
        // b. Arrays to store marks, percentage, and grades
        double[][] marks = new double[n][3]; // [student][0=Physics,1=Chemistry,2=Maths]
        ...
        for (int i = 0; i < n; i++) {
            ...
            percentage[i] = (total / 300) * 100; // assuming max marks for each subject is 100
